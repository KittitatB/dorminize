  ...
  <body class="fixed-nav sticky-footer bg-dark" id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
          <li class="nav-item active" data-toggle="tooltip" data-placement="right" title="ข้อมูลหอพัก">
    ...
    <div class="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <!-- 
        <ol class="breadcrumb">
          <li class="breadcrumb-item active">ที่อยู่หอพัก</li>
        </ol>
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item active">รายละเอียดหอพัก</li>
        </ol>
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item active">รายละเอียดห้อง</li>
        </ol>
-->
      <ol class="breadcrumb">
     <div class="row">
